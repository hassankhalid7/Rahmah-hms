    ...
    return (
        <div className="relative">
            <button
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-gray-50 rounded-xl sm:rounded-2xl hover:bg-brand-50 transition-colors relative group border border-gray-100 shadow-sm active:scale-90"
            >
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute right-0 mt-4 w-[min(92vw,24rem)] sm:w-96 bg-white rounded-3xl sm:rounded-[40px] shadow-2xl border border-gray-100 z-50 overflow-hidden animate-in zoom-in-95 duration-200 origin-top-right">
                        <div className="p-5 sm:p-8 border-b border-gray-50 flex items-center justify-between gap-3 bg-gray-50/50">
                            <div>
                        ...
                        <div className="max-h-[65vh] sm:max-h-[400px] overflow-y-auto divide-y divide-gray-50 p-3 sm:p-4 space-y-2">
                            {notifications.map((n) => (
