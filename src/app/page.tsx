  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#1c3c33] font-sans overflow-x-hidden selection:bg-[#2F6B4F] selection:text-white">
      ...
      <img
        ...
        alt=""
        className="fixed top-0 left-0 w-[400px] h-[400px] object-contain -translate-x-1/2 -translate-y-1/2 opacity-15 pointer-events-none z-0 mix-blend-multiply"
      />

      {/* Navbar Container */}
      <div className="relative z-50 mx-auto max-w-7xl px-6 pt-6">
        <nav className="flex items-center justify-between rounded-full bg-white/80 backdrop-blur-md px-6 py-3 shadow-sm border border-[#2F6B4F]/5">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 bg-[#1c3c33] rounded-xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform overflow-hidden border border-white/5">
                <Image src="/rahmah-logo.svg" alt="RAHMAH Logo" width={40} height={40} className="object-cover" />
              </div>
              <span className="text-2xl font-black italic tracking-tight text-[#2F6B4F] flex items-center gap-1 drop-shadow-sm">
                Rahmah
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/register" className="rounded-full bg-[#2F6B4F] px-6 py-2 text-sm font-bold text-white shadow-lg shadow-[#2F6B4F]/20 hover:bg-[#255740] hover:scale-105 transition-all">
              {t[lang].register}
            </Link>
            <Link href="/sign-in" className="rounded-full bg-[#fae8b4] px-6 py-2 text-sm font-bold text-[#1c3c33] shadow-md hover:bg-[#ffe196] hover:scale-105 transition-all">
              {t[lang].login}
            </Link>
          </div>
        </nav>
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-12 pb-32 lg:pt-20 overflow-hidden">
        {/* Wavy shape background - Natural tone */}
        <div className="absolute top-0 right-0 w-[60%] h-[85%] bg-[#FDFBF7] rounded-bl-[150px] -z-10"></div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative z-10 pt-10">
              ...
              <h1 className="text-5xl lg:text-6xl font-black leading-[1.1] tracking-tight text-[#1c3c33] mb-6 drop-shadow-sm">
                {t[lang].heroTitle}
                <br />
              ...
              <p className="max-w-lg text-lg leading-relaxed text-[#1c3c33]/70 font-medium mb-8">
                {t[lang].heroDesc}
              </p>

              <div className="flex flex-wrap items-center gap-4">
                <Link href="/register" className="rounded-full bg-[#2F6B4F] px-8 py-3.5 text-sm font-bold text-white shadow-[0_20px_40px_rgba(47,107,79,0.25)] hover:bg-[#255740] hover:translate-y-[-2px] transition-all flex items-center gap-2">
                  {t[lang].getStarted}
                </Link>
                <button type="button" className="rounded-full bg-[#FDFBF7] border-2 border-[#E1D7C3] px-8 py-3.5 text-sm font-bold text-[#1c3c33] shadow-sm hover:bg-[#F3D083]/10 hover:border-[#F3D083] transition-all">
                  {t[lang].watchDemo}
                </button>
              </div>
            </div>
            ...
            <div className="relative lg:h-[600px] flex items-center justify-center">
              <div className="relative w-full max-w-[550px] aspect-square">
                ...
                {/* Floral decorations */}
                <img src="/decor-flowers.png" alt="" className="absolute -bottom-10 -left-16 w-48 h-48 object-contain z-20 rotate-[-15deg] mix-blend-multiply" />
                <img src="/decor-flowers.png" alt="" className="absolute -bottom-4 -right-8 w-40 h-40 object-contain z-20 rotate-[35deg] scale-x-[-1] mix-blend-multiply" />
                <img src="/decor-flowers.png" alt="" className="absolute top-0 right-10 w-24 h-24 object-contain z-0 opacity-60 rotate-[180deg] mix-blend-multiply" />
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center">
                  ...
                  <div className="absolute top-[20%] -left-[5%] bg-white p-4 rounded-2xl shadow-[0_15px_40px_rgba(47,107,79,0.15)] z-20 border border-[#2F6B4F]/5 animate-[bounce_3s_infinite]">
                    <div className="flex items-center gap-3">
      ...
      <section className="bg-white pb-24 pt-12 relative z-10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-black text-[#1c3c33] mb-4">{t[lang].completeSolution}</h2>
            <p className="text-[#1c3c33]/60 text-lg">{t[lang].completeSolutionDesc}</p>
          </div>
      ...
      <section className="py-16 bg-[#FDFBF7] relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#1c3c33] mb-12">{t[lang].powerfulFeatures}</h2>
            ...
            {/* Tech Benefits */}
            <h2 className="text-3xl font-black text-[#1c3c33] mb-12">{t[lang].techBenefits}</h2>
      ...
      <section className="relative mt-20">
        ...
        <div className="bg-[#2F6B4F] pt-0 pb-16 relative z-10">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-20">
            ...
            {/* Footer Info Grid */}
            <div className="grid md:grid-cols-4 gap-8 text-left border-t border-white/20 pt-10 text-white/90">
