    ...
    try {
        ...
        if (isDemoMode) {
            return NextResponse.json([
                { id: '1', studentId: 'STU001', name: 'Amir Ali', firstName: 'Amir', lastName: 'Ali', email: 'amir@student.com', status: 'active', admissionDate: '2025-01-15' },
                { id: '2', studentId: 'STU002', name: 'Sara Ahmed', firstName: 'Sara', lastName: 'Ahmed', email: 'sara@student.com', status: 'active', admissionDate: '2025-02-10' },
                { id: '3', studentId: 'STU003', name: 'Umar Farooq', firstName: 'Umar', lastName: 'Farooq', email: 'umar@student.com', status: 'active', admissionDate: '2025-03-01' },
            ]);
        }
    ...
    try {
        ...
        if (isDemoMode) {
            ...
            return NextResponse.json({
                ...
                studentNumber: 'STU-' + Math.floor(Math.random() * 900 + 100),
